...
var moduleStatements = r(sp, /(?:requires|author_requires|configureRequires|test_requires|conflicts|recommends)/, sp, moduleOrmoduleNameVersion, el);
var comment = r(sp, /#[^\n]*\n/);
var sub = r(sp, /sub\s*\{/, rrepeat(r(moduleStatements, or, comment), '*'), /\}/);
